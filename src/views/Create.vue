<template>
  <div class="max-w-screen-md mx-auto px-4 py-10">
    ...
    <!-- Form -->
      <form @submit.prevent="createWorkout" class="flext flex-col gap-y-5 w-full">
      ...
      >
        ...
        <div v-if="workoutType === 'cardio'" class="flex flex-col gap-y-4">
          <div class="flex flex-col gap-x-6 gap-y-2 relative md:flex-row" v-for="(item, index) in exercises" :key="index">
            ...
            <select id="cardio-type" required class="p-2 w-full text-grey-500 focus:outline-none" v-model="item.cardioType"> 
  ...
  setup() {
    ...
    const createWorkout = async() => {
      try {
        ...
        statusMsg.value = "Success: Workout created successfully!";
    ...
    return { workoutName, workoutType, exercises, statusMsg, errorMsg, addExercise, deleteExercise, workoutChange, createWorkout  };
  },
};
</script>
